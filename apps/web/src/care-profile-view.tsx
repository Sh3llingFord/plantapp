...
/** Vollständige Pflegeprofil-Anzeige — gemeinsam für Katalog- und eigene Pflanzen-Detailseite. */
export function CareProfileView({ profile }: { profile: CareProfile }) {
